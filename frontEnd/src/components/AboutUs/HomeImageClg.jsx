    ...
    <Container>
      <div className="grid items-center md:gap-36 p-10 md:p-20 md:grid-cols-2 grid-rows-1">
        <div className="relative rounded-xl mb-15 w-full mx-0 md:w-full md:mx-0 min-h-[300px] md:min-h-0">
          ...
          <div className="animate-float-x-reverse absolute bottom-7 right-2/6 -translate-x-1/2 md:left-auto md:translate-x-0 md:right-2/5 md:-bottom-20 z-10 flex w-fit items-center space-x-3 md:space-x-4 rounded-lg bg-[#fff2dd] p-2 md:p-4 shadow-md transition-transform duration-300 hover:scale-105">
        ...
        <div className="animate-slide-in space-y-6">
          <div className="mb-3">
            <h2 className="mb-1 text-xl md:text-2xl font-bold text-gray-700">About Us</h2>
