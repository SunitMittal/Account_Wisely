    ...
    <Container>
      <div className="grid items-center md:gap-36 md:p-20 md:grid-cols-2 grid-rows-1 px-20">
        <div className="relative rounded-xl mb-15">
          ...
          <div className="animate-float-x absolute -top-8 -left-30 md:top-6 md:right-28 z-10 flex w-fit items-center space-x-4 rounded-lg bg-[#fff2dd] p-4 shadow-md transition-transform duration-300 hover:scale-105">
          ...
          <div className="animate-float-x-reverse absolute left-8 -bottom-40 md:right-2/5 md:-bottom-18 z-10 flex w-fit items-center space-x-4 rounded-lg bg-[#fff2dd] p-4 shadow-md transition-transform duration-300 hover:scale-105">
