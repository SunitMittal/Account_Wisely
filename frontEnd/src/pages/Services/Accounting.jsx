        ...
        <div className="my-6 lg:px-10 sm:my-8 sm:px-4.5">
          ...
          <div>
            ...
            <p className="my-2 text-lg leading-7 text-gray-600 sm:my-2 sm:leading-7">
              ...
              filings, we take the load off your team. Whether you're a startup,
              freelancer, solopreneur, online influencer or CA practice firm,
              we're here to help you grow—offering scalable, flexible solutions
          ...
          <div>
            ...
            <p className="text-lg leading-7 text-gray-600 sm:leading-7">
              ...
              decisions. We've helped firms to optimize their operations, reduce
          ...
          <div>
            ...
            <p className="my-1 text-gray-600 text-lg">
              ...
              to improve client satisfaction, ensure compliance, and streamline
            ...
            <ul className="text-gray-500 text-lg">
              <li>
                🔹{" "}
                <span className="font-bold text-gray-600">Stay tax-ready</span>{" "}
