...
const virtualCFO = () => {
  ...
  return (
    <>
      <LandingImage
        title="Virtual CFO Services in India – Strategic Finance Leadership, Without the Full-Time Cost"
          ...
          <div className="my-6 lg:px-10 sm:my-8 sm:px-4.5">
            <div>
              <h2 className="text-3xl font-bold sm:text-2xl md:text-3xl">
                Why do modern businesses need a Virtual CFO instead of a
                full-time CFO?
              </h2>
              ...
              <p className="mt-1 text-justify leading-7 text-gray-600 sm:mt-1 sm:leading-7 sm:text-lg">
                ...
                can be costly and unnecessary—especially for businesses with
                lean teams or limited budgets.
              </p>
            ...
            <div>
              ...
              <p className="mt-2 text-justify leading-7 text-gray-600 sm:mt-2 sm:leading-7 sm:text-lg">
                Growing businesses typically face three major financial
            ...
            <div>
              ...
              <ul className="mb-4 text-justify leading-7 text-gray-600 sm:mb-4 sm:leading-7 sm:text-lg sm:pl-7">
                <li>
                  • <span className="font-bold">Strategic Advisor</span>–
                  guiding key financial decisions
                </li>
                <li>
                  • <span className="font-bold">Financial Planner</span>–
                  managing budgets, cash flow, and forecasts
                </li>
                <li>
                ...
                <li>
                  ...
                  supporting expansion, funding, and long-term strategy
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold sm:text-xl md:text-2xl text-[#2e1566]">
                Which CFO service is best for growing businesses under ₹25
                Crore?
              </h3>
